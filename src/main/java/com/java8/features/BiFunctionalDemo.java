...
public class BiFunctionalDemo {
	...
	public static void main(String[] args) {
		...
		System.out.println("Result of 2 and 4 is : " + checkValue.test(2,  4));
		System.out.println("Result of 1 and 2  is : " + checkValue.test(1,  2));
		
		BiFunction<Integer, Integer, Integer> addValues = (i, j) -> (i + j);
		System.out.println("Addition of 2 and 5 is : " + addValues.apply(2,  5));
